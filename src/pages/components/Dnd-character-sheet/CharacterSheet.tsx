...
interface componentReference {
    componentReference: React.MutableRefObject<undefined>
    data: {
    ...
    dispatch: {
        characterNameSet: (event: React.ChangeEvent) => void,
        characterClassAndLevelSet: (event: React.ChangeEvent) => void,
        characterBackgroundlSet: (event: React.ChangeEvent) => void,
        characterPlayerNameSet: (event: React.ChangeEvent) => void,
        characterRaceSet: (event: React.ChangeEvent) => void,
        characterAlignmentSet: (event: React.ChangeEvent) => void,
        characterExperiencePointsSet: (event: React.ChangeEvent) => void,
        characterStrengthSet: (event: React.ChangeEvent) => void,
        characterDexteritySet: (event: React.ChangeEvent) => void,
        characterConstitutionSet: (event: React.ChangeEvent) => void,
        characterWisdomSet: (event: React.ChangeEvent) => void,
        characterIntelligenceSet: (event: React.ChangeEvent) => void,
        characterCharismaSet: (event: React.ChangeEvent) => void,
        characterProficiencyBonusSet: (event: React.ChangeEvent) => void,
        characterStrengthSaveSet: (event: React.ChangeEvent) => void,
        StrengthSaveProfSet: (event: React.ChangeEvent) => void,
        characterDexteritySaveSet: (event: React.ChangeEvent) => void,
        DexteritySaveProfSet: (event: React.ChangeEvent) => void,
        characterConstitutionSaveSet: (event: React.ChangeEvent) => void,
        ConstitutionSaveProfSet: (event: React.ChangeEvent) => void,
        characterWisdomSaveSet: (event: React.ChangeEvent) => void,
        WisdomSaveProfSet: (event: React.ChangeEvent) => void,
        characterIntelligenceSaveSet: (event: React.ChangeEvent) => void,
        IntelligenceSaveProfSet: (event: React.ChangeEvent) => void,
        characterCharismaSaveSet: (event: React.ChangeEvent) => void,
        CharismaSaveProfSet: (event: React.ChangeEvent) => void,
        characterAcrobaticsSaveSet: (event: React.ChangeEvent) => void,
        AcrobaticsSaveProfSet: (event: React.ChangeEvent) => void,
        characterAnimalHandlingSaveSet: (event: React.ChangeEvent) => void,
        AnimalHandlingSaveProfSet: (event: React.ChangeEvent) => void,
        characterArcanaSaveSet: (event: React.ChangeEvent) => void,
        ArcanaSaveProfSet: (event: React.ChangeEvent) => void,
        characterAthleticsSaveSet: (event: React.ChangeEvent) => void,
        AthleticsSaveProfSet: (event: React.ChangeEvent) => void,
        characterDeceptionSaveSet: (event: React.ChangeEvent) => void,
        DeceptionSaveProfSet: (event: React.ChangeEvent) => void,
        characterHistorySaveSet: (event: React.ChangeEvent) => void,
        HistorySaveProfSet: (event: React.ChangeEvent) => void,
        characterInsightSaveSet: (event: React.ChangeEvent) => void,
        InsightSaveProfSet: (event: React.ChangeEvent) => void,
        characterIntimidationSaveSet: (event: React.ChangeEvent) => void,
        IntimidationSaveProfSet: (event: React.ChangeEvent) => void,
        characterInvestigationSaveSet: (event: React.ChangeEvent) => void,
        InvestigationSaveProfSet: (event: React.ChangeEvent) => void,
        characterMedicineSaveSet: (event: React.ChangeEvent) => void,
        MedicineSaveProfSet: (event: React.ChangeEvent) => void,
        characterNatureSaveSet: (event: React.ChangeEvent) => void,
        NatureSaveProfSet: (event: React.ChangeEvent) => void,
        characterPerceptionSaveSet: (event: React.ChangeEvent) => void,
        PerceptionSaveProfSet: (event: React.ChangeEvent) => void,
        characterPerformanceSaveSet: (event: React.ChangeEvent) => void,
        PerformanceSaveProfSet: (event: React.ChangeEvent) => void,
        characterPersuasionSaveSet: (event: React.ChangeEvent) => void,
        PersuasionSaveProfSet: (event: React.ChangeEvent) => void,
        characterReligionSaveSet: (event: React.ChangeEvent) => void,
        ReligionSaveProfSet: (event: React.ChangeEvent) => void,
        characterSleightofHandSaveSet: (event: React.ChangeEvent) => void,
        SleightofHandSaveProfSet: (event: React.ChangeEvent) => void,
        characterStealthSaveSet: (event: React.ChangeEvent) => void,
        StealthSaveProfSet: (event: React.ChangeEvent) => void,
        characterSurvivalSaveSet: (event: React.ChangeEvent) => void,
        SurvivalSaveProfSet: (event: React.ChangeEvent) => void,
        characterPassivePerceptionSet: (event: React.ChangeEvent) => void,
        characterOtherprofsSet: (event: React.ChangeEvent) => void,
        characterArmorClassSet: (event: React.ChangeEvent) => void,
        characterInitiativeSet: (event: React.ChangeEvent) => void,
        characterSpeedSet: (event: React.ChangeEvent) => void,
        characterMaxHPSet: (event: React.ChangeEvent) => void,
        characterCurrentHPSet: (event: React.ChangeEvent) => void,
        characterTempHPSet: (event: React.ChangeEvent) => void,
        characterTotalHDSet: (event: React.ChangeEvent) => void,
        characterRemainingHDSet: (event: React.ChangeEvent) => void,
        characterdeathSuccess1Set: (event: React.ChangeEvent) => void,
        characterdeathSuccess2Set: (event: React.ChangeEvent) => void,
        characterdeathSuccess3Set: (event: React.ChangeEvent) => void,
        characterDeathFail1Set: (event: React.ChangeEvent) => void,
        characterDeathFail2Set: (event: React.ChangeEvent) => void,
        characterDeathFail3Set: (event: React.ChangeEvent) => void,
        characterAtkName1Set: (event: React.ChangeEvent) => void,
        characterAtkbonus1Set: (event: React.ChangeEvent) => void,
        characterAtkDamage1Set: (event: React.ChangeEvent) => void,
        characterAtkName2Set: (event: React.ChangeEvent) => void,
        characterAtkbonus2Set: (event: React.ChangeEvent) => void,
        characterAtkDamage2Set: (event: React.ChangeEvent) => void,
        characterAtkName3Set: (event: React.ChangeEvent) => void,
        characterAtkbonus3Set: (event: React.ChangeEvent) => void,
        characterAtkDamage3Set: (event: React.ChangeEvent) => void,
        characterCPSet: (event: React.ChangeEvent) => void,
        characterSPSet: (event: React.ChangeEvent) => void,
        characterEPSet: (event: React.ChangeEvent) => void,
        characterGPSet: (event: React.ChangeEvent) => void,
        characterPPSet: (event: React.ChangeEvent) => void,
        attacksAndSpellCastingSet: (event: React.ChangeEvent) => void,
        characterEquipmentSet: (event: React.ChangeEvent) => void,
        characterPersonalitySet: (event: React.ChangeEvent) => void,
        characterIdealsSet: (event: React.ChangeEvent) => void,
        characterBondsSet: (event: React.ChangeEvent) => void,
        characterFlawsSet: (event: React.ChangeEvent) => void,
        characterFeaturesSet: (event: React.ChangeEvent) => void,
    }
}
